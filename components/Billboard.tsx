  ...
  return (
    <div className="relative h-[56.25vw]">
      ...
      <div className=" absolute top-[30%] md:top-[40%] ml-4 md:ml-16">
        ...
        <p
          className="
        text-white text-[8px] md:text-lg mt-3 md:mt-8
        w-[90%]
        md:w-[80%]
        lg:w-[50%]
        drop-shadow-xl
        ...
        <div className="flex flex-row items-center mt-3 space-x-2 md:mt-4 gap3">
          ...
          <button
            ...
            bg-opacity-30
            text-white 
            rounded-md py-1 md:py-2
            px-2 md:px-4 w-auto text-xs lg:text-lg
